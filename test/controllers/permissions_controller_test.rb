...
class PermissionsControllerTest < ActionController::TestCase
  ...
  test "should create permission" do
    assert_difference('Permission.count') do
      post :create, permission: { action: @permission.action, name: @permission.name, subject_class: @permission.subject_class }
    end
  ...
  test "should update permission" do
    patch :update, id: @permission, permission: { action: @permission.action, name: @permission.name, subject_class: @permission.subject_class }
    assert_redirected_to permission_path(assigns(:permission))
  end
